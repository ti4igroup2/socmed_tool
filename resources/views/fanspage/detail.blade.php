@extends('layout.main')
@section('title',"FansPage Post Manager")
@section('content-header')
<div class="row align-items-center">
    <div class="col-md-12">
        <div class="page-header-title">
            <h3 class="m-b-10">FANSPAGE POST MANAGER</h3>
        </div>
        <ul class="breadcrumb">
            <li class="breadcrumb-item"><a href="#"><i class="feather icon-layers"></i></a></li>
            <li class="breadcrumb-item"><a href="#!">FansPage Post List</a></li>
        </ul>
    </div>
</div>
@endsection
@section('content')
<input type="hidden" id="fpid" value="{{Request::segment(2)}}">
              ...
              <div class="form-row">
                  ...
                  <div class="form-group col-md-12 mt-3">
                    ...
                    <span style="float:right;">
                      <button type="button" id="reloadpost" class="btn btn-success btn-sm text-dark"><i class="fab fa-facebook"></i> Refresh All Post</a>
...
<script src="{{config('app.url')}}/assets/assets/plugins/waterball/js/createWaterBall-jquery.js"></script>
    <script type='text/javascript' src='{{config('app.url')}}/js/post.js'></script>
@endpush