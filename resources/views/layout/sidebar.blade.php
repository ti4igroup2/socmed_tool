        ...
        <div class="navbar-wrapper">
            ...
            <div class="navbar-content scroll-div">
                <ul class="nav pcoded-inner-navbar">
                    ...
                    <li  class="nav-item pcoded-hasmenu {{ Request::segment(1)=="socmed" || Request::segment(1)=="alexa" ? 'active pcoded-trigger' : '' || Request::segment(1)=="detail_fbpage"  ? 'active pcoded-trigger' : ''  || Request::segment(1)=="fbpage"  ? 'active pcoded-trigger' : '' }} ">
                        ...
                        <ul class="pcoded-submenu">
                            ...
                            <li class="{{ Request::url() == url('/fbpage') ? 'active' : '' || Request::segment(1)=="detail_fbpage"  ? 'active' : ''  }}"><a href="{{config('app.url')}}/fbpage"><i class="fa fa-circle-o"></i>Fanspage</a></li>
                        </ul>
                    </li>
